...
-   Spatial data handling
    ...
    -   **sf**
        -   [*st_read( )*](https://www.rdocumentation.org/packages/sf/versions/0.7-2/topics/st_read) - import shapefile as a simple feature data frame.
    -   **rgdal**
    -   **spdep**
...
-   Attribute data handling
    ...
    -   **tidyverse**,
        ...
        -   [**ggplot2**](https://ggplot2.tidyverse.org/)
            ...
            \-- [*geom_histogram( )*](https://ggplot2.tidyverse.org/reference/geom_histogram.html) - display the counts with bars.

        -   [**dplyr**](https://dplyr.tidyverse.org/):

            *\-- [glimpse( )](https://dplyr.tidyverse.org/reference/glimpse.html)* - list variables by rows, data by columns.
...
-   Multivariate data visualisation and analysis
    ...
    -   **coorplot**
    -   **ggpubr**
        -   [*ggarrange( )*](https://rpkgs.datanovia.com/ggpubr/reference/ggarrange.html#value) - Arrange multiple ggplots on the same page.
    -   **heatmaply**
...
[Usage of the code chunk below]{style="color:#a39f9d"} : review the newly derived penetration rates.
...
[***ggplot( )*** - sf -]{style="color:#d46e15"} to plot the distribution of the variable i.e. " number of households with radio "

[***geom_histogram( )*** - ggplot2 -]{style="color:#d46e15"} to plot histogram to display the counts with bars.
...
-   Unlike frequency polygons [***geom_histogram( )***]{style="color:#d46e15"} that are more suitable to compare the distribution across the levels of a categorical variable.
...
[***geom_boxplot( )*** - ggplot2 -]{style="color:#d46e15"} to :
...
## 5.7 SPATIALLY CONSTRAINED CLUSTERING - SKATER APPROACH

Derive spatially constrained cluster by using [*skater()*](https://r-spatial.github.io/spdep/reference/skater.html) method of [**spdep**](https://r-spatial.github.io/spdep/) package.
...
[Usage of the code chunk below]{style="color:#a39f9d"} : plot the newly derived clusters by the SKATER method.
