...
[***sample( )*** - base -]{style="color:#d46e15"} to display only first 2 rows of data.
:::
...
[***pivot_wider( )*** - -]{style="color:#d46e15"} to display only first 2 rows of data.
:::
