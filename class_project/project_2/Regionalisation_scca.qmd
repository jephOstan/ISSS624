...
::: {.callout-warning appearance="simple" icon="false"} [Usage of the code chunk below :]{style="color:#a39f9d"}
...
24679/52148*100 #percentage of functional water points over their usage limit
```
