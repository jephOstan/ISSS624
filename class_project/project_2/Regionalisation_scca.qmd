...
Thereafter, get the coordinates for LGA Headquarters or Secretariat office via [**Google Maps**](https://www.google.com/maps).
...
-   According to Sphere Standards[^8], the distance from any household to the nearest water point should be less than 500 metres.

-   However, 15,011 water points cover entire communities within 1 km. This is approximately 15.8% of the total water points.

[^8]: 

    Sphere Association. *The Sphere Handbook : Humanitarian Charter and Minimum Standards in Humanitarian Response 2018 Edition.* Pg.106. https://spherestandards.org/wp-content/uploads/Sphere-Handbook-2018-EN.pdf
...
::: callout-note
Variables with VIF threshold value between 5 to 10 may need to be cautious but VIF greater than 10 can be problematic to the model performance due to serious collinearity problem.[^11]

"A VIF value of 10 means that the tolerance of the relevant independent variable is 0.10 and that 90% (𝐑𝟐) of the variable is explained by other variables. This is undesirable, as it indicates that **the relevant independent variable is unnecessarily included in the model**."[^12]
...
[^11]: Chouiry G. (2022). What is an Acceptable Value for VIF? (With References). https://quantifyinghealth.com/vif-threshold/

[^12]: ResearchGate. Multicollinearity issues: is a value less than 10 acceptable for VIF? https://www.researchgate.net/post/Multicollinearity_issues_is_a\_value_less_than_10_acceptable_for_VIF
...
This is in spite of adjusting the *cex=* parameter that scales the resolution of the dendogram to 10%. [^13]
:::

[^13]: Chua Y.T. (2022). Take-home Exercise 2 - Regionalisation of Multivariate Water Point Attributes with Non-spatially Constrained and Spatially Constrained Clustering Methods. https://isss624-amelia.netlify.app/exercises/take-home_ex2/take-home_ex2#computing-hierarchical-clustering
