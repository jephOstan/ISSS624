...
::: {.callout-tip collapse="true" style="#| code-overflow: wrap" appearance="simple" icon="false"}
...
::: {.callout-note}
## reduce the file size with this function -> compress = "xz".
:::
...
::: {.callout-warning .column-page-inset-right appearance="simple" icon="false"}
```{r}
skim(wp_adm)
```
